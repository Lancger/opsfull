...
```
## 给节点打标签
[root@k8s-master01 ingress-master]# kubectl label nodes k8s-master02 node-ingress="true"
[root@k8s-master01 ingress-master]# kubectl label nodes k8s-master03 node-ingress="true"
