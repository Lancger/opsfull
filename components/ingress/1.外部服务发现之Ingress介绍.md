...
现在在浏览器中输入 [http://master_node_ip:23457 例如 http://16.21.206.156:35258/dashboard/ 注意这里是使用的IP] 就可以访问到 traefik 的 dashboard 了
