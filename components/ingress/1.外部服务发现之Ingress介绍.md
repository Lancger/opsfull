...
现在在浏览器中输入 node_ip:23457 就可以访问到 traefik 的 dashboard 了：
...
第一步，在本地的/etc/hosts里面添加上 traefik-ui.test.com 与 master 节点外网 IP 的映射关系

第二步，在浏览器中访问：http://traefik-ui.test.com 我们会发现并没有得到我们期望的 dashboard 界面，这是因为我们上面部署 traefik 的时候使用的是 NodePort 这种 Service 对象，所以我们只能通过上面的 23458 端口访问到我们的目标对象：http://traefik-ui.test.com:23458
